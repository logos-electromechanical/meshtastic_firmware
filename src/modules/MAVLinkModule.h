...
class MAVLinkModule : public StreamAPI, private concurrency::OSThread
{
    bool firstTime = 1;
...
extern MAVLinkModule *mavlinkModule;

/*
 * Radio interface for MAVLinkModule
 *
 */
class MAVLinkModuleRadio : public MeshModule
{
    uint32_t lastRxID = 0;
    char outbuf[90] = "";
...
extern MAVLinkModuleRadio *mavlinkModuleRadio;
